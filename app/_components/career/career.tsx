  ...
  const careerData = [
    {
      ...
      tags: ["프론트엔드", "클라이언트"],
      description:
        "스타트업에서 프로젝트를 처음부터 끝까지 만들고 운영하면서 프론트엔드 구조 설계, 상태 관리, API 연동, 실서비스 운영 경험을 깊게 쌓았습니다. AI 캐릭터 채팅 시스템을 도입하여 누적 유저 약 1만 명, 피크 100건/초 AI 채팅 요청이 발생하는 서비스를 안정적으로 운영했습니다.",
    },
    {
      company: "(주)에듀에듀",
