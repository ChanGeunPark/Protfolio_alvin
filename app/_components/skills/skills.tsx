...
const skillCategories: SkillCategory[] = [
  {
    ...
    items: [
      ...
      {
        name: "JavaScript",
        description: "브라우저 UI와 PHP 기반 서비스 흐름 구현",
        iconColor: "#F7DF1E",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "스키마 기반 타입 생성으로 API 변경 빌드 타임 검증",
        iconColor: "#F472B6",
        iconBg: "rgba(244,114,182,0.12)",
      },
      {
        name: "React Query",
        description: "지도 마커·상세 데이터의 캐시와 lazy fetch 제어",
        iconColor: "#FF4154",
        iconBg: "rgba(255,65,84,0.12)",
      },
      {
        name: "Framer Motion",
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: "Storybook",
        description: "디자인·코드 컴포넌트 기준을 단일화",
        iconColor: "#FF4785",
        iconBg: "rgba(255,71,133,0.12)",
      },
      {
        name: "Swiper",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Next.js 웹을 앱으로 래핑하고 Native Bridge 설계",
        iconColor: "#54C5F8",
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: "Supabase",
        description: "PostgreSQL·Auth·RLS 기반 데이터 권한 설계",
        iconColor: "#3ECF8E",
        iconBg: "rgba(62,207,142,0.12)",
      },
      {
        name: "Cloudflare Images",
        description: "이미지 업로드·전달 파이프라인 구성",
        iconColor: "#F38020",
        iconBg: "rgba(243,128,32,0.12)",
      },
    ],
    parallaxSpeed: 0.9,
    yOffset: -12,
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: "Claude CLI + Hono",
        description: "로컬 브릿지와 SSE로 AI 자동 제보 파이프라인 구현",
        iconColor: "#F97316",
        iconBg: "rgba(249,115,22,0.12)",
      },
    ],
  ...
  },
  {
    ...
    items: [
      {
        name: "Unity",
        description: "모바일 게임 클라이언트 구조와 성능 최적화",
        iconColor: "#FFFFFF",
        iconBg: "rgba(255,255,255,0.08)",
      },
      {
        name: "C#",
        description: "상태 기반 시스템과 에디터 자동화 구현",
        iconColor: "#A78BFA",
        iconBg: "rgba(167,139,250,0.12)",
      },
      {
        name: "DOTween",
        description: "Sequence 큐잉으로 UI/스킬 모션 제어",
        iconColor: "#E879F9",
        iconBg: "rgba(232,121,249,0.12)",
      },
      {
        name: "UniTask",
        description: "Unity 생명주기에 맞춘 비동기 처리",
        iconColor: "#60A5FA",
        iconBg: "rgba(96,165,250,0.12)",
      },
      {
        name: "MessagePack",
        description: "바이너리 직렬화로 모바일 데이터 로드 최적화",
        iconColor: "#34D399",
        iconBg: "rgba(52,211,153,0.12)",
      },
      {
        name: "NavMesh",
        description: "비동기 베이킹으로 배치 편집 프레임 드롭 완화",
        iconColor: "#FBBF24",
