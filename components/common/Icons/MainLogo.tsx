...
function MainLogo({ width = 96, height = 20, className, ...rest }: LogoProps) {
  return (
    <svg
      ...
      className={cls("mix-blend-difference fill-white", className)}
    >
      <path
        id="패스_41"
        data-name="패스 41"
      ...
      >
        <animate
          ...
          values="0.1;0.3;0.1;0.3;0.1;0.1;0.3;0.1;0.3;0.1"
          keyTimes="0;0.03;0.06;0.1;0.14;0.5;0.53;0.56;0.6;1"
          calcMode="discrete"
          dur="2.2s"
